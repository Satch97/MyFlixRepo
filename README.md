...
Flixster shows the latest movies currently playing in theaters. The app utilizes the Movie Database API to display images and basic information about these movies to the user in a user friendly, beautiful application.
...
Difficult to find the appropriate setup for the butterknife libraries.
